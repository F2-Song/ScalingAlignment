...
from infer_func import setup_seed
...
if __name__ == "__main__":
    ...
    if accelerator.is_main_process:
        for file_name in [
            ...
            save_path = os.path.join("inference_res", "infer_main_{}_{}_{}_{}".format(args.index, args.stage, args.directory, file_name))
    ...
    for file_name in [
        ...
        for index in range(len(infer_data)):
            ...
            infer_data[index]["infer"]["bleu"] = metrics.get_bleu(infer_data[index]['infer']['t'], infer_data[index]['suffix'][0])
